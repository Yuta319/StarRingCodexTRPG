...
from .runner import build_bundle, dump_bundle


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="StarRingCodexTRPG minimal world->scene->UI runner")
    ...
    parser.add_argument("--output", type=Path, help="Output bundle path. If omitted, JSON is printed to stdout.")
    return parser
...
def main(argv: list[str] | None = None) -> None:
    ...
    try:
        ...
        payload = dump_bundle(bundle, args.output)
