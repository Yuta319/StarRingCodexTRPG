...
- 初見で意味が通らない古語や造語を、説明なしで主表示へ置くこと
- 誤読や誤解を誘う命名を、世界観演出のために優先すること
...
- 主表示に使う語は、常用か、少なくともファンタジー文脈で十分に常用に近いものを選ぶ。
- `分かりにくい方が雰囲気が出る` という判断は採らない。
...
- 難しさよりも、まず意味が通ることを優先する。
- 造語や古語は、読者の常用感覚から大きく外れるなら避ける。
